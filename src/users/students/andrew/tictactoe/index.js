...
import { EMPTY_CELL, checkWinGame, getEmptySpaces, getFilledArray } from './tictactoe.js';
...
const askQuestions = async () => {
	const array = getFilledArray(PRE_FILL_COUNT, PLAYERS, ROWS_LENGTH, COLUMNS_LENGTH);
